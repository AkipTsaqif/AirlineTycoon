...
#define NUM_PLANE_BODY    5  //Anzahl der R�mpfe
#define NUM_PLANE_COCKPIT 5  //Anzahl der Cockpits
#define NUM_PLANE_HECK    7  //Anzahl der Hecks
#define NUM_PLANE_LWING   6  //Anzahl der hinteren Fl�gen
#define NUM_PLANE_MOT     8  //Anzahl der Motoren
#define NUM_PLANE_RWING   6  //Anzahl der vorderen Fl�gen
...
class CPlanePartRelation
{
   public:
      ...
      XY    Offset2d;       // Offset f�r die 2d-Ansicht am Flughafen
      XY    Offset3d;       // Offset f�r die 2d-Ansicht im Editor
      long  Note1;          // [CSV] Spezielle Anmerkung, z.B. zu auf/Aberwertung
      long  Note2;          // [CSV] dito
      long  Note3;          // [CSV] dito
      long  zAdd;
      long  Noise;          // [CSV] Zus�tzlicher L�rm
      const char *Slot;           // Dieser Slot wird ben�tigt (BCHLMR)
...
#define NOTE_PILOT1      109   //Zus�tzliche Piloten
#define NOTE_PILOT2      110   //Zus�tzliche Piloten
#define NOTE_PILOT3      111   //Zus�tzliche Piloten
#define NOTE_PILOT4      112   //Zus�tzliche Piloten
#define NOTE_BEGLEITER4  113   //Zus�tzliche Begleiter
#define NOTE_BEGLEITER6  114   //Zus�tzliche Begleiter
#define NOTE_BEGLEITER8  115   //Zus�tzliche Begleiter
#define NOTE_BEGLEITER10 116   //Zus�tzliche Begleiter
...
public:
   ...
   CString        PartUnderCursorB;  //Der andere Fl�gel, der ggf. mit dranklebt
   long           RelationIdUnderCursor;  //F�r das Snap-In die passende Relation

   bool           bBodyOutlined;     //Ist Body markiert?
   bool           bCockpitOutlined;  //Ist Cockpit markiert?
   bool           bHeckOutlined;     //Ist Heck markiert?
   bool           bWingOutlined;     //Sind Fl�gel markiert?
   ...
   long           sel_b;             // Index von 0.. f�r die aktuelle Wahl des Bodies
   long           sel_c;             // Index von 0.. f�r die aktuelle Wahl des Cockpits
   long           sel_h;             // Index von 0.. f�r die aktuelle Wahl des Hecks
   long           sel_w;             // Index von 0.. f�r die aktuelle Wahl des Fl�gels
   long           sel_m;             // Index von 0.. f�r die aktuelle Wahl des Motors
