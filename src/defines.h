...
//Bei DEMO werden folgende �nderungen gemacht:
// * Keine Werbeagentur, Insel, Nasa
// * Exception, wenn der Boss f�r die h�heren Missionen spricht
// * Keine Voices
// * Beschr�nkung auf 100 Tage
//#define DEMO            //Beschr�nkung der Missionen und einiges mehr
...
//#define NO_N_VOICES     //Keine niernerl�ndischen Voices, Sprechblasen werden eingeschaltet
//#define NO_INTRO        //Kein Intro, d.h. er wird �bersprungen
...
//Der Einfachheit halber Maximalwerte f�r ein paar Tabellen:
...
#define MAX_WORKERS    2000            //Maximale Zahl der Angestellten

//Sprache:
#define LANGUAGE_D       0             //D-Deutsch
#define LANGUAGE_E       1             //E-Englisch
#define LANGUAGE_F       2             //F-Franz�sisch
...
//Die Bitmaps f�r jedes Flugzeug:
...
//Die Schwierigkeitsgrade f�rs Spiel:
#define DIFF_TUTORIAL    0             //Tutorium: 3 Auftr�ge
#define DIFF_FIRST       1             //5000 Passagiere bef�rdern; keine 
#define DIFF_EASY        2
...
#define DIFF_ADDON03     13            //Fracht: Hilfsfl�ge x Tonnen
#define DIFF_ADDON04     14            //Flugkilometer
#define DIFF_ADDON05     15            //Kein Reiseb�ro
#define DIFF_ADDON06     16            //Alles modernisieren
#define DIFF_ADDON07     17            //Aktienkurs
#define DIFF_ADDON08     18            //Viele Auftr�ge
...
//Die Art eines geplanten/durchgef�hrten Fluges:
...
#define ITEM_LAPTOP      0        //Der Laptop f�rs Scheduling
#define ITEM_HANDY       1        //Telefon f�r Gespr�che
#define ITEM_NOTEBOOK    2        //Notizbuch f�r die Warp-Funktion
#define ITEM_FILOFAX     2        //Synonym
#define ITEM_MG          3        //F�r ArabAir
#define ITEM_BIER        4        //F�r Mechaniker
#define ITEM_ZIGARRE     5        //
#define ITEM_OEL         6        //�l f�r den Globus
...
#define GAMESTATE_BOOT     0     //Direkt nach Programmstart; Inhalt zuf�llig
...
#define GAMESTATE_WORKING  32    //Wird gerade von einem parallelen Fenster ver�ndert
#define GAMESTATE_DONE     64    //Wurde gerade ver�ndert. Der alte Pointer kann gel�scht werden
#define GAMESTATE_PAUSED   128   //Zus�tzliches Pauseflag
...
#define EDITOR_NODES       3     //Der Editor f�r die Nodes
#define EDITOR_LINKS       4     //Der Editor f�r die Node-Verbindungen

//Die verschiendenen Zust�nde der Personen
...
#define PERSON_2SHOP            10    //Person sucht ein Gesch�ft
#define PERSON_SHOPPING         11    //Person kauft im Gesch�ft ein
#define PERSON_EXSHOP           12    //Person geht zum Eingang/Ausgang
#define PERSON_DROPPING_SUICASE 13    //Person l��t den Koffer fallen
#define PERSON_2CHECKIN_EXIT    14    //Person will aus dem Check-In Bereich raus
#define PERSON_WAYPOINTING      15    //Person geht zum n�chsten WayPoint
...
#define PERSON_LEAVING          31    //Person wird demn�chst aussortiert
#define PERSON_TALKING          32    //Person schnackt mit Spieler
#define PERSON_BROWSEFLAG       64    //Person st�bert und l��t Platz f�r viele andere
#define PERSON_WAITFLAG         128   //zus�tzliches Flag, wenn Person nur ab & zu betreut wird
...
#define ROOM_OPTIONS       2     //Das Optionsmen� (Der Ausgang)
#define ROOM_STAIRSVON     50    //Bereich f�r...
...
#define ROOM_ARAB_AIR      104   //Der Schalter der omin�sen Fluglinie
#define ROOM_MAKLER        105   //Der Makler f�r neue Flugzeug
...
#define ROOM_REISEBUERO    111   //Das Reiseb�ro der anderen Linien
#define ROOM_SABOTAGE      112   //Raum f�r die Sabotage
#define ROOM_WC_F          113   //Das Damen-WC
#define ROOM_WC_M          114   //Das Herren-WC
#define ROOM_NASA          115   //Das B�ro der Nasa, wo man Dinge kaufen kann
#define ROOM_INSEL         116   //Die Raketenabschu�rampe
#define ROOM_WORLD         117   //Die Weltkugel f�r internationale Gespr�che
#define ROOM_RUSHMORE      118   //Die Weltkugel f�r internationale Gespr�che
...
#define ROOM_FLIGHTDISPLAY 140   //140-169 bzw. 170-199 sind reserviert f�r die Fluganzeigetafeln
#define ROOM_REISE_X1      200   //Reiseb�ro f�r G�ste #1
#define ROOM_REISE_X2      201   //Reiseb�ro f�r G�ste #2
#define ROOM_REISE_X3      202   //Reiseb�ro f�r G�ste #3
#define ROOM_REISE_X4      203   //Reiseb�ro f�r G�ste #4
#define ROOM_LASTMIN_X1    210   //LastMinute f�r G�ste #1
#define ROOM_LASTMIN_X2    211   //LastMinute f�r G�ste #2
#define ROOM_LASTMIN_X3    212   //LastMinute f�r G�ste #3
#define ROOM_LASTMIN_X4    213   //LastMinute f�r G�ste #4
...
#define ROOM_MONITOR1      230   //Fluglisten-Monitor #1 (f�r Passagiere)
#define ROOM_MONITOR2      231   //Fluglisten-Monitor #2 (f�r Passagiere)
#define ROOM_MONITOR3      232   //Fluglisten-Monitor #3 (f�r Passagiere)
#define ROOM_MONITOR4      233   //Fluglisten-Monitor #4 (f�r Passagiere)
#define ROOM_MONITOR5      234   //Fluglisten-Monitor #5 (f�r Passagiere)
#define ROOM_MONITOR6      235   //Fluglisten-Monitor #6 (f�r Passagiere)
#define ROOM_MONITOR7      236   //Fluglisten-Monitor #7 (f�r Spieler)
#define ROOM_MONITOR8      237   //Fluglisten-Monitor #8 (f�r Spieler)
#define ROOM_MONITOR9      238   //Fluglisten-Monitor #9 (f�r Spieler)
#define ROOM_PHONE1        240   //�ffentliches Telefon #1
#define ROOM_PHONE2        241   //�ffentliches Telefon #2
#define ROOM_PHONE3        242   //�ffentliches Telefon #3
#define ROOM_PHONE4        243   //�ffentliches Telefon #4
#define ROOM_ELECTRO       244   //Der Colaautomat
#define ROOM_AIRPORT_EXIT  250   //Flughafenausgang
#define ROOM_WALL          254   //Mauer, Spieler mu� davor stehen
#define ROOM_ANTIMARKER    255   //L�scht eine Markierung; f�r L�cherm z.B. f�r Briefkasten
#define ROOM_TITLE         900   //
#define ROOM_ENTERING      1024  //Flag: Spieler betritt Raum
#define ROOM_LEAVING       2048  //Flag: Spieler verl��t Raum
...
#define OBST_POINT          01   //Punktf�rmiges Hindernis
#define OBST_WIDE           02   //Breites Hindernis
#define OBST_SITPOINT       03   //Punktf�rmiges Hindernis (Sitz)
#define OBST_HORIZONTAL     10   //Horizontale Abgrenzung
#define OBST_VERTIKAL       11   //Vertikale Abgrenzung
#define OBST_BIGVERTIKAL    12   //Gro�e vertikale Abgrenzung
#define OBST_HORIZONTALEXIT 20   //Horizontale Ausgang in der Fensterreihe hinten
#define OBST_SHOPFRONT      21   //Der Eingang zu einem Gesch�ft
#define OBST_STAIRFRONT     22   //Der Eingang zur Treppe
#define OBST_BUROFRONT_R    23   //Der Eingang zum B�ro (Eingang rechts)
...
#define OBST_BUROFRONT_L    27   //Der Eingang zum B�ro (Eingang links)
...
#define RUNE_PCREATION2      2003  //Player Creation Node beim B�ro
#define RUNE_PDESTRUCTION    2003  //Der Ausgang f�r den Spieler
#define RUNE_UP              2010  //Pflicht: nach Norden
#define RUNE_RIGHT           2011  //Pflicht: nach Osten
#define RUNE_SOUTH           2012  //Pflicht: nach S�den
...
#define RUNE_NORTHSOUTH      2023  //Pflicht: Norden oder S�den
#define RUNE_NOPLAYER        2025  //Verboten f�r Spieler
#define RUNE_NOCLIENT        2026  //Verboten f�r Kunden
...
#define RUNE_RIGHTSOUTH      2037  //Pflicht: nach Osten o. S�den
#define RUNE_SOUTHLEFT       2038  //Pflicht: nach S�den o. Westen
...
#define RUNE_WAYPOINT_WAIT   2057  //WayPoint: Wait f�r 3 Seconds
#define RUNE_NOLEFT          2060  //kein Weg nach links
#define RUNE_NODOWN          2061  //kein Weg nach s�den
...
#define RUNE_CLIPNONE        2067  //zur n�chsten Area
#define RUNE_CONDBLOCK       2070  //Conditional Block

#define BRICK_ELECTRO         303  //Colaautomat
#define BRICK_KASTEN          471  //Kofferschlucker
#define BRICK_SCANNER_DARKLY  283  //Durchleuchter f�r Skelette

//Die Gr�nde, warum eine Person am Flughafen sein kann:
#define REASON_SHOPPING      50    //Will nur in Gesch�fte
...
//Dinge f�r den Roboter (Computerspieler):
...
#define ACTION_CHECKAGENT2    211     //Reiseb�ro
#define ACTION_CHECKAGENT3    212     //Frachtraum
#define ACTION_MEETING        220     //Geht zur morgentlichen Besprechung
#define ACTION_STARTDAY       221     //Geht ins B�ro
#define ACTION_BUERO          221     //Geht ins B�ro
#define ACTION_PERSONAL       222     //Geht ins Personalb�ro
...
#define BERATERTYP_GIRL        0    //Die Sekret�rin
...
//Die Leute die sprechen k�nnen:
#define TALKER_NONE          -1
#define TALKER_PERSONAL1a     0     //Die Leute in den Personalr�umen
...
#define MEDIUM_HANDY          1     //Hier gehen Men�s nicht
...
#define MENU_REQUEST          5     //Irgenteine R�ckfrage
...
#define MENU_FLUEGE          13     //Liste mit allen Fl�gen
#define MENU_WC_F            14     //Pseudo-Men�, um die Tastatureingaben zu blockieren
#define MENU_WC_M            15     //Pseudo-Men�, um die Tastatureingaben zu blockieren
...
#define MENU_AUSLANDSAUFTRAG 20     //Telefon: Die Auftr�ge aus dem Ausland
#define MENU_PLANECOSTS      21     //Die Reparaturkosten f�r die Flugzeuge
#define MENU_PLANEREPAIRS    22     //Die Reparaturbefehle f�r die Flugzeuge
...
#define MENU_ENTERTCPIP      39     //Host f�r's Internet eingeben
#define MENU_ENTERPROTECT    40     //Den Code f�r den Kopierschutz eingeben
...
#define MENU_REQUEST_KILLCITY       3  //Stadt k�ndigen
#define MENU_REQUEST_KILLROUTE      4  //Route k�ndigen
#define MENU_REQUEST_WRONGROOM      5  //Falscher Raum. Wollen Sie zu ...?
#define MENU_REQUEST_KILLITEM       6  //Ein Item wegwerfen
#define MENU_REQUEST_KILLAUFTRAG    7  //Einen Auftrag zur�ckgeben und die Strafe bezahlen
#define MENU_REQUEST_KILLAUFTRAG0   8  //Einen Auftrag zur�ckgeben
#define MENU_REQUEST_KILLPLAN       9  //Flugplan l�schen?
#define MENU_REQUEST_WRONGROOM2    10  //Wenn der entsprechende Spieler bei einem leeren B�ro rausgeflogen ist
#define MENU_REQUEST_THROWNOUT2    11  //Kein Raum, sondern ein offenes B�ro
...
#define MENU_REQUEST_FORBIDDEN     17  //Kein Einla�, weil man vorher zu lange da war
#define MENU_REQUEST_DESTROYED     18  //Kein Einla�, weil man vorher zu lange da war
#define MENU_REQUEST_ITEMS         19  //Nicht genug Platz f�r Items
...
#define MENU_REQUEST_KILLFAUFTRAG  27  //Einen Auftrag zur�ckgeben und die Strafe bezahlen
#define MENU_REQUEST_KILLFAUFTRAG0 28  //Einen Auftrag zur�ckgeben
...
#define MENU_REQUEST_KILLPLANE     38  //Flugzeug im Editor komplett l�schen
...
#define CURSOR_HOT            1     //Click-F�hig
#define CURSOR_EXIT           3     //Raum verlassen
#define CURSOR_LEFT           4     //Man kann bl�ttern
#define CURSOR_RIGHT          5     //Man kann bl�ttern
#define CURSOR_MOVE_H         6     //Man kann verschieben
#define CURSOR_MOVE_V         7     //Man kann verschieben

//Modi f�r die Animationsroutine
...
#define AMBIENT_JET_OUTSIDE    1    //Ein Jet f�hrt drau�en vorbei
#define AMBIENT_JET_FIELD      2    //Man ist drau�en auf dem Airfield

//Die Flags f�r die Raktenbauteile:
#define ROCKET_BASE            1    //Die Standbasis
#define ROCKET_TOWER           2    //Das Halteger�st
#define ROCKET_ARM             4    //Der Arm am Halteger�st
#define ROCKET_PART_ONE        7    //Der erste Teil

#define ROCKET_AIRFRAME        8    //Der Rahmen
#define ROCKET_WINGS          16    //Fl�gel
...
#define ROCKET_PART_TWO_A    127    //Der zweite Teil halb (f�r die Zeitungsmeldung)
#define ROCKET_ALL          1023    //Die gesammte Rakete

//Die Flags f�r die Stationsbauteile:
...
#define STATION_PART_TWO      255    //Der zweite Teil halb (f�r die Zeitungsmeldung)
...
//Die Statistik-Daten:
#define STAT_ANZ               40    //Die Anzahl der �berwachten Eigenschaften
#define STAT_KONTO              0
#define STAT_KREDIT             1
#define STAT_FLUGZEUGE          2
#define STAT_PASSAGIERE         3    //Die Summe der bef�rderten Passagiere
#define STAT_PASSAGIERE_HOME    4      //davon die, die �ber den Heimatflughafen geflogen sind
#define STAT_AKTIENKURS         5
#define STAT_FLUEGE             6    //Fl�ge (egal welcher Art), die durchgef�hrt wurden
#define STAT_AUFTRAEGE          7    //Gesammtanzahl der angenommen (nicht geflogenen!) Auftr�ge
...
#define STAT_UNFAELLE          15    //Soviele Unf�lle gab's beim Spieler
#define STAT_SABOTIERT         16    //Soviele Unf�lle hat der Spieler in Auftrag gegeben
#define STAT_MITARBEITER       17
#define STAT_MISSIONSZIEL      18    //Soweit vom Missionsziel (in%) ist erreicht; Vorsicht! Kann gr��er als 100 sein!!!
...
#define STAT_E_VERKAEUFE		 32		// Flugzeuge, Aktien, Ausr�stung u.s.w.
...
#define STAT_A_KAEUFE			 37		// Flugzeuge, Aktien, Ausr�stung u.s.w.
#define STAT_A_SONSTIGES		 38		// Essen, Zinsen, Dividenden, Telefon ** +STRAFEN **

#define STAT_FRACHTEN          39    //Gesammtanzahl der angenommen (nicht geflogenen!) Frachtauftr�ge

//Er�ffnungen f�r die Dialoge:
...
#define ROBOT_USE_FRACHT             2  //Frachtauftr�ge annehmen
#define ROBOT_USE_WERBUNG            3  //Werbung machen
#define ROBOT_USE_AUFSICHT           4  //Die Korktafel in der Aufsicht regelm��ig nutzen (Niederlasstungen erwerben)
...
#define ROBOT_USE_FORCEROUTES        9  //Routen immer verwenden (Ohne-Auftr�ge Mission)
#define ROBOT_USE_HARDWERBUNG       10  //Viel Geld f�r Werbung ausgeben?
#define ROBOT_USE_SELLSHARES        11  //Computerspieler 2 kann schon fr�hzeitig Aktien verkaufen
#define ROBOT_USE_BUYOWNSHARES      12  //Computerspieler kann eigene Aktien zur�ckkaufen
#define ROBOT_USE_REBUYSHARES       13  //Teil der eigenen Aktien nach Emission zur�ckkaufen
#define ROBOT_USE_TUTORIALLIMIT     14  //Zahl der Auftr�ge anhand des Tutoriallimits begrenzen
#define ROBOT_USE_ROUTEMISSION      15  //Levelziel: bestimmte Routen
#define ROBOT_USE_MUCHWERBUNG       16  //Der Werbung einen hohen Stellenwert einr�umen? (z.B. f�r Image-Mission)
#define ROBOT_USE_BONUS_X2          17  //Doppelter Bonus f�r Computergegner in diesem Level?
#define ROBOT_USE_BONUS_X4          18  //Vierfacher Bonus f�r Computergegner in diesem Level?
#define ROBOT_USE_BONUS_X8          19  //Achtfacher Bonus f�r Computergegner in diesem Level?
...
#define ROBOT_USE_PAYBACK_CREDIT    23  //Spielziel: Kredit zur�ckzahlen
#define ROBOT_USE_MUCH_FRACHT       24  //Frachtauftr�ge sind wichtig
#define ROBOT_USE_FREE_FRACHT       25  //Frachtauftr�ge ohne Gewinn sind sehr attraktiv
#define ROBOT_USE_RUN_FRACHT        26  //Spieler rennt morgens zu Fracht-Auftr�gen
#define ROBOT_USE_LUXERY            27  //Robots setzen auf Luxus
#define ROBOT_USE_TRAVELHOLDING     28  //Gibt es die Holdinggesellschaft f�r die Reiseb�ros
#define ROBOT_USE_IMAGEBONUS        29  //Robots erh�lten t�glich einen Imagebonus
#define ROBOT_USE_GOODPLANES        30  //Robots reparieren immer alles und sofort
#define ROBOT_USE_REPAIRPLANES      31  //Flugzeug ist kaputt und mu� vorsichtig repariert werden
#define ROBOT_USE_HIGHSHAREPRICE    32  //Robots verwenden hohen Aktienzielkurs
#define ROBOT_USE_WORKQUICK         33  //Robots sind in den R�umen sehr schnell fertig
#define ROBOT_USE_GROSSESKONTO      34  //Robots sparen viel auf dem Konto an
#define ROBOT_USE_EMITMUCHSHARES    35  //Robots geben Aktien aus wann immer sie k�nnen
#define ROBOT_USE_WORKVERYQUICK     36  //Robots sind in den R�umen sehr sehr schnell fertig
...
#define ROBOT_USE_SHORTFLIGHTS      45  //Kurze Fl�ge bevorzugen
...
#define ROBOT_USE_TANKS             51  //Spieler verwendet die Tanks um g�nstig Kerosin zu horten
