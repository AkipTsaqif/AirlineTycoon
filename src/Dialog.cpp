...
//--------------------------------------------------------------------------------------------
//Vor allem anderen einen Klick auf den Berater pr�fen:
//--------------------------------------------------------------------------------------------
BOOL CStdRaum::PreLButtonDown (CPoint point)
{
   ...
   {
      //Klick ignorieren, wenn er erst anf�ngt zu reden:
      ...
      //Verhindern, da� ein Doppelklick ein Thema zweimal aufbringt:
      ...
      {
         return (TRUE);  //kein g�ltiger Klick
      }

      BOOL bIsNetworkDialog = (DialogPartner==TALKER_COMPETITOR && Sim.Players.Players[DialogPar1].Owner==2);

      //Bei Netzwerkdialogen wird ein Klick ignoriert, wenn der andere Spieler gerade etwas ausw�hlt:
      ...
      switch (DialogPartner)
      {
         case TALKER_ARAB:
            switch (id)
            {
               ...
               case 200: //Allgem Infos gew�nscht: (evtl Verweis zu 251)
               ...
               case 400: //Spieler kann sich f�r Kerosinpreis entschieden:
               case 401:
               ...
               case 202: //etwas �ber die Tanks erz�hlen
               ...
               case 500: //Spieler mu� Menge ausw�hlen
               case 620:
...
//#endif
         ...
         case TALKER_BANKER2:
            switch (id)
            {
               ...
               case 102: //Will Kredit zur�ckzahlen:
                  MenuDialogReEntryB=-1;
         ...
         case TALKER_BOSS:
            switch (id)
            {
               ...
               case 2081:
                  ...
                  DialogPar2=0;
                  DialogPar3=0;   //Der wievielte Spieler ist das? (F�r Er�ffnungssatz) Wenn Spieler 0 rausfliegt, bekommt Spieler 1 den Er�ffnungssatz.
               ...
               case 6000:
                  {
                     ...
                     for (SLONG c=0; c<Sim.Players.Players.AnzEntries(); c++)
                        if (!Sim.Players.Players[c].IsOut)
                        {
                           ...
                           if (TmpStr2.GetLength()>0) TmpStr2+="�";
                           //TmpStr+="[[*]] ";
...
_und_jetzt_weiter_mit_etc:
               ...
               case 20230: case 20231: //Image zu schlecht
                  ...
                  //absichtlich kein break, sondern n�chster Spieler:
               ...
               case 3002:
                  do
                  {
                     DialogPar1++;  //N�chster Spieler
                     DialogPar3++;  //N�chster Er�ffnungssatz
                  }
                  while (DialogPar1<4 && Sim.Players.Players[DialogPar1].IsOut);
...
_ehemals_2080:
               ...
               case 2074:
                  ...
                  if (DialogPar1>=Sim.SabotageActs.AnzEntries())
                  {
                     ...
                     ((CAufsicht*)this)->ExitFromMiddle=12; //Alle einmal b�se anblicken
               ...
               case 5010: case 5020:
                  {
                     ...
                     if (Sim.Overtake==1) //Schlucken
                     {
                        ...
                        //Flugzeuge �bernehmen, Flugpl�ne l�schen, alle nach Berlin setzen, ggf. Leute daf�r einstellen
                        ...
                        //Von dem �bernommenen hat keiner mehr Aktien:
                        for (c=0; c<Sim.Players.Players.AnzEntries(); c++)
                           Sim.Players.Players[c].OwnsAktien[Sim.OvertakenAirline]=0;
                     ...
                     else if (Sim.Overtake==2) //Liquidieren
                     {
                        ...
                        for (c=0; c<4; c++)
                           if (!Sim.Players.Players[c].IsOut && Sim.Players.Players[c].OwnsAktien[Sim.OvertakenAirline])
                              ...
                              //                            Changed: ^ war SLONG und damit vermutlich f�r einen Bug verantwortlich
         ...
         case TALKER_PERSONAL4b:
            switch (id)
            {
               ...
               case 960:
                  ...
                  qPlayer.StrikeEndType  = 2;       //Streik beendet durch Gehaltserh�hunh
         ...
         case TALKER_COMPETITOR:
            {
               ...
               switch (id)
               {
                  ...
                  case 2001: case 2011: case 2021: case 2031:
                     ...
                     {
                        //Was will der Computerspieler? Kooperation ver�ndern!
                  ...
                  case 20200: //Einer schl�gt Kooperation vor:
                     DialogPar2^=1;
                     if (DialogPar2)
                  ...
                  case 20400: //Kooperation beginnen:
                     ...
                     {
                        //Was will der Computerspieler? Tsch�ss!
                  ...
                  case 20210: //Kooperation k�ndigen (brutal):
                  ...
                  case 20211: //Kooperation k�ndigen (sanft):
                     qOther.Kooperation[Sim.localPlayer]=FALSE;
                     qPlayer.Kooperation[DialogPar1]=FALSE;
