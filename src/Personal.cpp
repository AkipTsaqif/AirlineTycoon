//============================================================================================
// Personal.Cpp - Das Personalb�ro des Spielers
//============================================================================================
// Link: "Personal.h"
//============================================================================================
#include "stdafx.h"
...
CPersonal::CPersonal(BOOL bHandy, ULONG PlayerNum) : CStdRaum (bHandy, PlayerNum, "personal.gli", GFX_PERSONAL)
{
   ...
   SP_Frau.Clips[8].ReSize (8, "PFTurnW.smk", "", XY (340, 113), SPM_LISTENING,  CRepeat(1,1), CPostWait(20,20), SMACKER_CLIP_CANCANCEL,
                            NULL, SMACKER_CLIP_SET, 0, NULL,  //Zuh�ren
                            "A9A1E1E1", 8, 10, 7, 9);
...
//--------------------------------------------------------------------------------------------
//L�dt die Tabelle von der Platte
//--------------------------------------------------------------------------------------------
void CWorkers::ReInit (const CString &TabFilename, const CString &TabFilename2)
{
   ...
   MNames.ReSize (0);
   LNames.ReSize (0);
   FNames.ReSize (MAX_PNAMES1);
   MNames.ReSize (MAX_PNAMES1);
   LNames.ReSize (MAX_PNAMES2);
...
//--------------------------------------------------------------------------------------------
//Neuer Tag, die Leute sind etwas ungl�cklicher und der Arbeitsmarkt �ndert sich:
//--------------------------------------------------------------------------------------------
void CWorkers::NewDay (void)
{
   ...
   //Eingestellte Leute bei Mensch-Spielern ungl�cklich machen:
   for (c=0; c<Workers.AnzEntries(); c++)
   {
      ...
      if (Workers[c].Employer>=0 && Workers[c].Employer<=3)
      {
         ...
         //Worker u.U. mehrfach um 1%-Punkt ungl�cklicher machen
         for (; Anz>0; Anz--)
         {
            Workers[c].Happyness--;
...
//--------------------------------------------------------------------------------------------
//Erh�ht oder erniedrigt einer Personen das Gehalt
//--------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------
//Verhindert, da� es zu wenig Piloten oder Stewardessen gibt:
//--------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------
//Erh�ht oder erniedrigt allen Personen das Gehalt
//--------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------
//Stellt sicher, da� der gew�nschte Berater heute im Angebot ist:
//--------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------
//Ver�ndert die Happiness aller Worker um den angegebenen Betrag:
//--------------------------------------------------------------------------------------------
