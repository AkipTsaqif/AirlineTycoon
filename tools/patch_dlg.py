...
f"  E::%s day(s) left to fix their image or they will be removed from the airport.{NL}"
f"  F::Il reste %s jour(s) pour am{E_ACUTE}liorer leur image, sinon ils seront renvoy{E_ACUTE}s.{NL}"
f"  I::Restano %s giorno/i per migliorare la reputazione, altrimenti verranno rimossi.{NL}"
f"  N::Nog %s dag(en) om het imago te verbeteren, anders volgt verwijdering.{NL}"
