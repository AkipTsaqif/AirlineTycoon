//============================================================================================
// Brick.Cpp - Funktionen f�r die Verwaltung der baulichen Elemente:
//============================================================================================
#include "StdAfx.h"
...
//--------------------------------------------------------------------------------------------
//Die Ausma�e einer Brick-Bitmap zur�ckgeben:
//--------------------------------------------------------------------------------------------
...
{
   //Hier stand �berall fr�her PrimaryBm statt Offscreen...
...
//--------------------------------------------------------------------------------------------
//F�r Editor: Ist Mauscursor auf Glas oder auf echtem Baustein?
//--------------------------------------------------------------------------------------------
...
void BRICK::UpdateBrick (void)
{
   ...
   if (ReloadNecessary)
   {
      ...
      if (AnzPhases>1)
      {
         //Speicher f�r die Animationsphasen bereitstellen:
         Bitmap.ReSize (AnzPhases);

         //Dies wird jetzt wieder als Z�hler verwendet:
         AnzPhases=0;
      ...
      {
         //Speicher f�r die Animationsphases bereitstellen:
         Bitmap.ReSize (1);
...
//--------------------------------------------------------------------------------------------
//L�dt nachtr�glich die Tabelle mit den Bricks:
//--------------------------------------------------------------------------------------------
...
void BRICKS::UpdateBricks (void)
{
   ...
   if (!bFirstClass)
   {
      for (c=0; c<8; c++)
      {
         //Hiermit l�schen wir die Smacker-Platzhalter an den Gates. Die dienen beim Editieren als optische Hilfe zur Positionierung, aber im Spiel k�nnen wir sie nicht gebrauchen
...
//--------------------------------------------------------------------------------------------
//L�scht alle Elemente des Flughafens:
//--------------------------------------------------------------------------------------------
...
void BUILDS::Load (SLONG Hall, SLONG Level)
{
   ...
   //Wenn der Flughafen f�r einen Level nicht existiert, dann Fallback auf den Difficulty-Level davor probieren
   do
   {
   ...
   {
      // Level file not found — fall back to previous level so missing expanded
...
//--------------------------------------------------------------------------------------------
//Sortiert alle Elemente des Flughafens gem�� ihrer Z-Position:
//--------------------------------------------------------------------------------------------
